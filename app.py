...
d = {'GPT Commands': ['GOOGLE("question")', 'MAKEFILE("content\\nhere", filename.txt)', 'READFILE(filename.txt)', 'LISTFILES()'],
     'GPT Explanations': ['Search Google with the given text and return the results', 'Make a file with the given content and file name', 'Read the content of a given filename', 'List the files you have access to'],
     'Raw Translation': ['python plugins/google.py {}', 'echo {} > files/{}', 'cat files/{}', 'ls files']
     }
